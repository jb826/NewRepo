 ...
 * 
 */
@WebServiceClient(name = "SoapImplService", targetNamespace = "http://ws.mkyong.com/", wsdlLocation = "http://localhost:9999/ws/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPIMPLSERVICE_QNAME = new QName("http://ws.mkyong.com/", "SoapImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/ws/soap?wsdl");
    ...
    public SoapService getSoapImplPort() {
        return super.getPort(new QName("http://ws.mkyong.com/", "SoapImplPort"), SoapService.class);
    }
     ...
     */
    @WebEndpoint(name = "SoapImplPort")
    public SoapService getSoapImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mkyong.com/", "SoapImplPort"), SoapService.class, features);
    }
